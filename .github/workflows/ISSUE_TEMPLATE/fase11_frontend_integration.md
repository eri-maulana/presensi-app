    name: "[Phase 11] Frontend Integration — Send presensi (photo+gps)"
    description: "Checklist for [Phase 11] Frontend Integration — Send presensi (photo+gps) - follow tasks and mark done"
    title: "[Phase 11] Frontend Integration — Send presensi (photo+gps)"
    labels: ["phase-11_frontend_integration", "todo"]
    assignees: []
    ...
    body:
      - type: markdown
        attributes:
          value: |
            ## 🎯 Purpose / Tujuan
            [Phase 11] Frontend Integration — Send presensi (photo+gps)
...
**Instructions:** Kerjakan checklist di bawah ini satu per satu. Setiap item mewakili tugas harian yang sebaiknya dikerjakan untuk phase ini.
      ...
      - type: checkboxes
        ...
        attributes:
          ...
          options:
            - label: "Review design & requirement for [Phase 11] Frontend Integration — Send presensi (photo+gps)"
