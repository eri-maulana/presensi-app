    name: "[Phase 16] Verification Workflow — Manual Verify by Lecturer"
    description: "Checklist for [Phase 16] Verification Workflow — Manual Verify by Lecturer - follow tasks and mark done"
    title: "[Phase 16] Verification Workflow — Manual Verify by Lecturer"
    labels: ["phase-16_verification_workflow", "todo"]
    assignees: []
    ...
    body:
      - type: markdown
        attributes:
          value: |
            ## 🎯 Purpose / Tujuan
            [Phase 16] Verification Workflow — Manual Verify by Lecturer
...
**Instructions:** Kerjakan checklist di bawah ini satu per satu. Setiap item mewakili tugas harian yang sebaiknya dikerjakan untuk phase ini.
      ...
      - type: checkboxes
        ...
        attributes:
          ...
          options:
            - label: "Review design & requirement for [Phase 16] Verification Workflow — Manual Verify by Lecturer"
