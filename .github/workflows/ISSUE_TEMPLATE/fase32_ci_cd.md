    name: "[Phase 32] CI/CD — GitHub Actions for tests & deploy"
    description: "Checklist for [Phase 32] CI/CD — GitHub Actions for tests & deploy - follow tasks and mark done"
    title: "[Phase 32] CI/CD — GitHub Actions for tests & deploy"
    labels: ["phase-32_ci_cd", "todo"]
    assignees: []
    ...
    body:
      - type: markdown
        attributes:
          value: |
            ## 🎯 Purpose / Tujuan
            [Phase 32] CI/CD — GitHub Actions for tests & deploy
...
**Instructions:** Kerjakan checklist di bawah ini satu per satu. Setiap item mewakili tugas harian yang sebaiknya dikerjakan untuk phase ini.
      ...
      - type: checkboxes
        ...
        attributes:
          ...
          options:
            - label: "Review design & requirement for [Phase 32] CI/CD — GitHub Actions for tests & deploy"
