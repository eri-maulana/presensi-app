    name: "[Phase 34] UAT — User Acceptance Testing"
    description: "Checklist for [Phase 34] UAT — User Acceptance Testing - follow tasks and mark done"
    title: "[Phase 34] UAT — User Acceptance Testing"
    labels: ["phase-34_uat", "todo"]
    assignees: []
    ...
    body:
      - type: markdown
        attributes:
          value: |
            ## 🎯 Purpose / Tujuan
            [Phase 34] UAT — User Acceptance Testing
...
**Instructions:** Kerjakan checklist di bawah ini satu per satu. Setiap item mewakili tugas harian yang sebaiknya dikerjakan untuk phase ini.
      ...
      - type: checkboxes
        ...
        attributes:
          ...
          options:
            - label: "Review design & requirement for [Phase 34] UAT — User Acceptance Testing"
