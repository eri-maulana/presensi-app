    name: "[Phase 8] Presensi Endpoint — POST /api/presensi"
    description: "Checklist for [Phase 8] Presensi Endpoint — POST /api/presensi - follow tasks and mark done"
    title: "[Phase 8] Presensi Endpoint — POST /api/presensi"
    labels: ["phase-8_presensi_endpoint", "todo"]
    assignees: []
    ...
    body:
      - type: markdown
        attributes:
          value: |
            ## 🎯 Purpose / Tujuan
            [Phase 8] Presensi Endpoint — POST /api/presensi
...
**Instructions:** Kerjakan checklist di bawah ini satu per satu. Setiap item mewakili tugas harian yang sebaiknya dikerjakan untuk phase ini.
      ...
      - type: checkboxes
        ...
        attributes:
          ...
          options:
            - label: "Review design & requirement for [Phase 8] Presensi Endpoint — POST /api/presensi"
