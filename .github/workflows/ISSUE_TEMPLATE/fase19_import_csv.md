    name: "[Phase 19] Import CSV — Bulk import mahasiswa"
    description: "Checklist for [Phase 19] Import CSV — Bulk import mahasiswa - follow tasks and mark done"
    title: "[Phase 19] Import CSV — Bulk import mahasiswa"
    labels: ["phase-19_import_csv", "todo"]
    assignees: []
    ...
    body:
      - type: markdown
        attributes:
          value: |
            ## 🎯 Purpose / Tujuan
            [Phase 19] Import CSV — Bulk import mahasiswa
...
**Instructions:** Kerjakan checklist di bawah ini satu per satu. Setiap item mewakili tugas harian yang sebaiknya dikerjakan untuk phase ini.
      ...
      - type: checkboxes
        ...
        attributes:
          ...
          options:
            - label: "Review design & requirement for [Phase 19] Import CSV — Bulk import mahasiswa"
