    name: "[Phase 28] Mobile Compatibility — test on Android/iOS"
    description: "Checklist for [Phase 28] Mobile Compatibility — test on Android/iOS - follow tasks and mark done"
    title: "[Phase 28] Mobile Compatibility — test on Android/iOS"
    labels: ["phase-28_mobile_compat", "todo"]
    assignees: []
    ...
    body:
      - type: markdown
        attributes:
          value: |
            ## 🎯 Purpose / Tujuan
            [Phase 28] Mobile Compatibility — test on Android/iOS
...
**Instructions:** Kerjakan checklist di bawah ini satu per satu. Setiap item mewakili tugas harian yang sebaiknya dikerjakan untuk phase ini.
      ...
      - type: checkboxes
        ...
        attributes:
          ...
          options:
            - label: "Review design & requirement for [Phase 28] Mobile Compatibility — test on Android/iOS"
