    name: "[Phase 1] Database Design — Desain Database & ERD"
    description: "Checklist for [Phase 1] Database Design — Desain Database & ERD - follow tasks and mark done"
    title: "[Phase 1] Database Design — Desain Database & ERD"
    labels: ["phase-1_database_design", "todo"]
    assignees: []
    ...
    body:
      - type: markdown
        attributes:
          value: |
            ## 🎯 Purpose / Tujuan
            [Phase 1] Database Design — Desain Database & ERD
...
**Instructions:** Kerjakan checklist di bawah ini satu per satu. Setiap item mewakili tugas harian yang sebaiknya dikerjakan untuk phase ini.
      ...
      - type: checkboxes
        ...
        attributes:
          ...
          options:
            - label: "Review design & requirement for [Phase 1] Database Design — Desain Database & ERD"
