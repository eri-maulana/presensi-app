    name: "[Phase 36] Maintenance & Handover — docs & training"
    description: "Checklist for [Phase 36] Maintenance & Handover — docs & training - follow tasks and mark done"
    title: "[Phase 36] Maintenance & Handover — docs & training"
    labels: ["phase-36_maintenance", "todo"]
    assignees: []
    ...
    body:
      - type: markdown
        attributes:
          value: |
            ## 🎯 Purpose / Tujuan
            [Phase 36] Maintenance & Handover — docs & training
...
**Instructions:** Kerjakan checklist di bawah ini satu per satu. Setiap item mewakili tugas harian yang sebaiknya dikerjakan untuk phase ini.
      ...
      - type: checkboxes
        ...
        attributes:
          ...
          options:
            - label: "Review design & requirement for [Phase 36] Maintenance & Handover — docs & training"
