    name: "[Phase 29] Testing & Validation — unit & feature tests"
    description: "Checklist for [Phase 29] Testing & Validation — unit & feature tests - follow tasks and mark done"
    title: "[Phase 29] Testing & Validation — unit & feature tests"
    labels: ["phase-29_testing_validation", "todo"]
    assignees: []
    ...
    body:
      - type: markdown
        attributes:
          value: |
            ## 🎯 Purpose / Tujuan
            [Phase 29] Testing & Validation — unit & feature tests
...
**Instructions:** Kerjakan checklist di bawah ini satu per satu. Setiap item mewakili tugas harian yang sebaiknya dikerjakan untuk phase ini.
      ...
      - type: checkboxes
        ...
        attributes:
          ...
          options:
            - label: "Review design & requirement for [Phase 29] Testing & Validation — unit & feature tests"
