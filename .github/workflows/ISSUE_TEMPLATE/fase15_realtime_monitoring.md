    name: "[Phase 15] Realtime Monitoring — Polling / Websockets"
    description: "Checklist for [Phase 15] Realtime Monitoring — Polling / Websockets - follow tasks and mark done"
    title: "[Phase 15] Realtime Monitoring — Polling / Websockets"
    labels: ["phase-15_realtime_monitoring", "todo"]
    assignees: []
    ...
    body:
      - type: markdown
        attributes:
          value: |
            ## 🎯 Purpose / Tujuan
            [Phase 15] Realtime Monitoring — Polling / Websockets
...
**Instructions:** Kerjakan checklist di bawah ini satu per satu. Setiap item mewakili tugas harian yang sebaiknya dikerjakan untuk phase ini.
      ...
      - type: checkboxes
        ...
        attributes:
          ...
          options:
            - label: "Review design & requirement for [Phase 15] Realtime Monitoring — Polling / Websockets"
