    name: "[Phase 6] API: Jadwal Hari Ini — Endpoint jadwal"
    description: "Checklist for [Phase 6] API: Jadwal Hari Ini — Endpoint jadwal - follow tasks and mark done"
    title: "[Phase 6] API: Jadwal Hari Ini — Endpoint jadwal"
    labels: ["phase-6_jadwal_endpoint", "todo"]
    assignees: []
    ...
    body:
      - type: markdown
        attributes:
          value: |
            ## 🎯 Purpose / Tujuan
            [Phase 6] API: Jadwal Hari Ini — Endpoint jadwal
...
**Instructions:** Kerjakan checklist di bawah ini satu per satu. Setiap item mewakili tugas harian yang sebaiknya dikerjakan untuk phase ini.
      ...
      - type: checkboxes
        ...
        attributes:
          ...
          options:
            - label: "Review design & requirement for [Phase 6] API: Jadwal Hari Ini — Endpoint jadwal"
