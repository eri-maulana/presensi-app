    name: "[Phase 2] Authentication — Setup Auth & Roles"
    description: "Checklist for [Phase 2] Authentication — Setup Auth & Roles - follow tasks and mark done"
    title: "[Phase 2] Authentication — Setup Auth & Roles"
    labels: ["phase-2_authentication", "todo"]
    assignees: []
    ...
    body:
      - type: markdown
        attributes:
          value: |
            ## 🎯 Purpose / Tujuan
            [Phase 2] Authentication — Setup Auth & Roles
...
**Instructions:** Kerjakan checklist di bawah ini satu per satu. Setiap item mewakili tugas harian yang sebaiknya dikerjakan untuk phase ini.
      ...
      - type: checkboxes
        ...
        attributes:
          ...
          options:
            - label: "Review design & requirement for [Phase 2] Authentication — Setup Auth & Roles"
