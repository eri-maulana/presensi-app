    name: "[Phase 30] Audit Logging — activity logs"
    description: "Checklist for [Phase 30] Audit Logging — activity logs - follow tasks and mark done"
    title: "[Phase 30] Audit Logging — activity logs"
    labels: ["phase-30_audit_logging", "todo"]
    assignees: []
    ...
    body:
      - type: markdown
        attributes:
          value: |
            ## 🎯 Purpose / Tujuan
            [Phase 30] Audit Logging — activity logs
...
**Instructions:** Kerjakan checklist di bawah ini satu per satu. Setiap item mewakili tugas harian yang sebaiknya dikerjakan untuk phase ini.
      ...
      - type: checkboxes
        ...
        attributes:
          ...
          options:
            - label: "Review design & requirement for [Phase 30] Audit Logging — activity logs"
