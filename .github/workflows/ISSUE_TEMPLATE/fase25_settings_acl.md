    name: "[Phase 25] Settings & ACL — System configs & Roles"
    description: "Checklist for [Phase 25] Settings & ACL — System configs & Roles - follow tasks and mark done"
    title: "[Phase 25] Settings & ACL — System configs & Roles"
    labels: ["phase-25_settings_acl", "todo"]
    assignees: []
    ...
    body:
      - type: markdown
        attributes:
          value: |
            ## 🎯 Purpose / Tujuan
            [Phase 25] Settings & ACL — System configs & Roles
...
**Instructions:** Kerjakan checklist di bawah ini satu per satu. Setiap item mewakili tugas harian yang sebaiknya dikerjakan untuk phase ini.
      ...
      - type: checkboxes
        ...
        attributes:
          ...
          options:
            - label: "Review design & requirement for [Phase 25] Settings & ACL — System configs & Roles"
