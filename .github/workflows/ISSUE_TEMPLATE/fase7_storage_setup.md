    name: "[Phase 7] Storage & Upload — Setup storage link & upload"
    description: "Checklist for [Phase 7] Storage & Upload — Setup storage link & upload - follow tasks and mark done"
    title: "[Phase 7] Storage & Upload — Setup storage link & upload"
    labels: ["phase-7_storage_setup", "todo"]
    assignees: []
    ...
    body:
      - type: markdown
        attributes:
          value: |
            ## 🎯 Purpose / Tujuan
            [Phase 7] Storage & Upload — Setup storage link & upload
...
**Instructions:** Kerjakan checklist di bawah ini satu per satu. Setiap item mewakili tugas harian yang sebaiknya dikerjakan untuk phase ini.
      ...
      - type: checkboxes
        ...
        attributes:
          ...
          options:
            - label: "Review design & requirement for [Phase 7] Storage & Upload — Setup storage link & upload"
