    name: "[Phase 20] Session Presensi — Open/Close Presensi Session"
    description: "Checklist for [Phase 20] Session Presensi — Open/Close Presensi Session - follow tasks and mark done"
    title: "[Phase 20] Session Presensi — Open/Close Presensi Session"
    labels: ["phase-20_session_presensi", "todo"]
    assignees: []
    ...
    body:
      - type: markdown
        attributes:
          value: |
            ## 🎯 Purpose / Tujuan
            [Phase 20] Session Presensi — Open/Close Presensi Session
...
**Instructions:** Kerjakan checklist di bawah ini satu per satu. Setiap item mewakili tugas harian yang sebaiknya dikerjakan untuk phase ini.
      ...
      - type: checkboxes
        ...
        attributes:
          ...
          options:
            - label: "Review design & requirement for [Phase 20] Session Presensi — Open/Close Presensi Session"
