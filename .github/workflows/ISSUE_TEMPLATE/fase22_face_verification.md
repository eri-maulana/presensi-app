    name: "[Phase 22] Face Verification (optional) — POC embeddings"
    description: "Checklist for [Phase 22] Face Verification (optional) — POC embeddings - follow tasks and mark done"
    title: "[Phase 22] Face Verification (optional) — POC embeddings"
    labels: ["phase-22_face_verification", "todo"]
    assignees: []
    ...
    body:
      - type: markdown
        attributes:
          value: |
            ## 🎯 Purpose / Tujuan
            [Phase 22] Face Verification (optional) — POC embeddings
...
**Instructions:** Kerjakan checklist di bawah ini satu per satu. Setiap item mewakili tugas harian yang sebaiknya dikerjakan untuk phase ini.
      ...
      - type: checkboxes
        ...
        attributes:
          ...
          options:
            - label: "Review design & requirement for [Phase 22] Face Verification (optional) — POC embeddings"
